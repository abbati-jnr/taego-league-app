...
import 'package:taego_league_app/theme2/screens/LeagueFormScreen.dart';
...
class LeagueScreen extends StatefulWidget {
  ...
  LeagueScreen({this.isDirect = false});
...
class LeagueScreenState extends State<LeagueScreen> {
  ...
  _deleteLeague(int id) async {
    var resp = await ApiService.deleteLeague(context, id);

    if (resp != null) {
      snackBar(context, title: "League Deleted");
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      GestureDetector(
                        onTap: () {
                          LeagueFormScreen().launch(context);
                        },
                        child: Row(
                          children: <Widget>[
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemCount: leagueStore.leagues.length,
                    shrinkWrap: true,
                    itemBuilder: (context, index) {
                      var league = leagueStore.leagues[index];
                      return Padding(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: <Widget>[
                                            Text(league.name, style: primaryTextStyle(color: appStore.textPrimaryColor, size: 18)),
                                            // SizedBox(height: 4),
                                            // Text(mListings[index].duration, style: primaryTextStyle(size: 14)),
                                            SizedBox(height: 4),
                                            Text(league.description, style: primaryTextStyle(size: 14), maxLines: 1),
                                            SizedBox(height: 4),
                                          ],
                                        ),
                                      )
